...
<html lang="en" >
	...
	<body class="whitebody">
		...
		<div class="container">
		   ...
		   <span><?php echo $container4->shippingContainer->name.' '.$container4->shippingContainer->lastname; ?></span>
		     <img src="<?php echo $container4->shippingContainer->profile_image; ?>"/>  
		    </div>
			<div class="scroller">
				<div class="room room--current">
					<div class="room__side room__side--back whiteback">
					<?php
					foreach($container4->Shipping_container_product as $cont1) { 
					//	print_r($cont1);die;
						?>
					...
					<div class="room__side room__side--left whiteleft">						
					<div class ="count1">						
						<div class ="count2" >
						<h2><span><img class="" src="img/set6/eye.png" alt="Some image"/></span>Total views <?php echo $container4->shippingContainer->Visit_count; ?></h2>
						</div>
						</div>
					</div>

					<div class="room__side room__side--right whiteright">
					<label></label><label></label><label></label><label></label><label></label><label></label><label></label><label></label><label></label><label>
							...
							<?php
					foreach($container4->Shipping_container_video as $cont1) { 
					...
					<?php }else { ?>
						...
						<!--  <a class ="left-wall" href ="#"><div class="bgnew"><img class="room__img img" src="<?php echo $container4->Shipping_container_video[1]->video; ?>" alt="Some image"/></div></a> -->
...
$(function() {                      
 $(".clickable").click(function() {  
  ...
  title = $(this).attr('title');
   id = $(this).attr('id'); 
link = '<?= base_url('billing?id=')?>'+id+'&cid=4';

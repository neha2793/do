...
<html lang="en" class="no-js">
	...
	<body >
		...
		<div class="container">
		   ...
		   <a href= "<?php echo base_url();?>/profile/?id=<?php echo $slimecontainer->shippping_container->user_id?>"><span><?php echo $slimecontainer->shippping_container->name.' '.$slimecontainer->shippping_container->lastname; ?></span>
		     <img src="<?php echo $slimecontainer->shippping_container->profile_image; ?>"/> </a> 
		    </div>
			<div class="scroller">
				<div class="room room--current">
					...
					foreach($slimecontainer->slime_seat as $seat) { 
						$imgext = explode(".",$seat->images[0]->Image_path);
						
						?>
				<div class="cloudimage-360 clickable" title="<?php echo $seat->name;?>" 
						description="<?php echo $seat->Description;?>" id="<?php echo $seat->product_id;?>" price ="<?php echo $seat->Price;?>" data-folder="<?php echo $slimecontainer->image_folder_path;?>" 
...
<?php } ?>	
					...
					<div class="room__side room__side--left ">
						<div class ="count1">
							<div class ="count2" >
								<h2><span><img class="" src="img/set6/eye.png" alt="Some image"/></span>Total views <?php echo $slimecontainer->shippping_container->Visit_count; ?></h2>
							</div>
						</div>
					...
					<div class="room__side room__side--right ">
					    					<?php
					foreach($slimecontainer->sc_video as $cont1) { 
		...
		<div class="modal fade model-design chairmodal slimecontainer" id="myModal" >
...
link = '<?= base_url('billing?id=')?>'+id+'&cid=7';

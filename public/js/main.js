...
//	alert(document.documentElement.clientWidth);
	...
	var	currentRoom = 0,
		...
		// Initial transform.
		initTransform = { translateX : 0, translateY : 0, translateZ : '800px', rotateX : 0, rotateY : 0, rotateZ : 0 },
		// Reset transform.
		...
		initTransition = { speed: '1.9s', easing: 'ease' },
		// Room moving transition.
		roomTransition = { speed: '0.4s', easing: 'ease' },
		// View from top transition.
		menuTransition = { speed: '1.5s', easing: 'cubic-bezier(0.3,1,0.3,1)' },
		// Info transition.
		infoTransition = { speed: '15s', easing: 'cubic-bezier(0.3,1,0.3,1)' },
		// Tilt transition
		tiltTransition = { speed: '0.7s', easing: 'ease-out' },
		tilt = false,
		// How much to rotate when the mouse moves.
		tiltRotation = {
			rotateX : -5, // a relative rotation of -1deg to 1deg on the x-axis
			rotateY : -35  // a relative rotation of -3deg to 3deg on the y-axis
		},
